...
// This is a helper function to get the Basic TrezoaAnchor program.
export function getBasicProgram(provider: TrezoaAnchorProvider, address?: PublicKey): Program<Basic> {
