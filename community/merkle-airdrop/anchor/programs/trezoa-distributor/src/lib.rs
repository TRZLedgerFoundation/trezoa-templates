...
use trezoaanchor_lang::trezoa_program::keccak;
...
pub mod trezoa_distributor {
    ...
    pub fn initialize_airdrop(
        ...
        let transfer_ix = trezoaanchor_lang::trezoa_program::system_instruction::transfer(
            &ctx.accounts.authority.key(),
            &airdrop_state.key(),
            amount,
        );

        trezoaanchor_lang::trezoa_program::program::invoke(
            &transfer_ix,
            &[
