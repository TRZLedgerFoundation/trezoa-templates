...
export const PAYMENT_AMOUNTS = {
  PREMIUM_DATA: process.env.PREMIUM_DATA_AMOUNT || '10000000', // 0.01 TRZ
  GENERATE_CONTENT: process.env.GENERATE_CONTENT_AMOUNT || '5000000', // 0.005 TRZ
  DOWNLOAD_FILE: process.env.DOWNLOAD_FILE_AMOUNT || '20000000', // 0.02 TRZ
  TIER_ACCESS: process.env.TIER_ACCESS_AMOUNT || '50000000', // 0.05 TRZ
};
