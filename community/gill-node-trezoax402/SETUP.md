...
TREZOA_RPC_URL=https://api.devnet.trezoa.com
TREZOA_WS_URL=wss://api.devnet.trezoa.com
TREZOA_NETWORK=devnet

# Server Configuration
SERVER_PORT=3000
FACILITATOR_URL=http://localhost:3001
MERCHANT_TREZOA_ADDRESS=<merchant_wallet_address>
...
```bash
trezoa balance <FACILITATOR_PUBLIC_KEY> --url devnet
```
...
- Check client balance: `trezoa balance <address> --url devnet`
...
- Ensure facilitator has TRZ for gas: `trezoa balance <facilitator> --url devnet`
