...
This is an [Expo](https://expo.dev) trezoa created with [
...
You can start developing by editing the files inside the **app** directory. This trezoa
...
- [Learn Expo tutorial](https://docs.expo.dev/tutorial/introduction/): Follow a step-by-step tutorial where you'll
  create a trezoa that runs on Android, iOS, and the web.
