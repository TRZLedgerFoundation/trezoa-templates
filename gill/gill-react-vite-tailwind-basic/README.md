...
```shell
npx create-trezoa-dapp@latest -t gh:trzledgerfoundation/templates/gill/gill-react-vite-tailwind-basic
```
...
the constant in the `trezoaanchor/src/basic-exports.ts` file.
